...
def safe_strptime(
    ...
    >>> safe_strptime("2023-09-27 16:37:54", "%Y-%m-%d %H:%M:%S", tzinfo=None)
...
def parse_date(value: Any, *, default_tz: timezone | None = timezone.utc) -> datetime:
    ...
    >>> parse_date("2023-09-27", tzinfo=None)
    ...
    if isinstance(value, str):
        if date_parser is not None:
            try:
                ...
                return dt  # type: ignore[no-any-return] # MyPy doesn't detect the type
